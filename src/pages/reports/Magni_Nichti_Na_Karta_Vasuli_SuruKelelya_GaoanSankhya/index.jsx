  ...
  const handleOnChangeDistrict = async (e) => {
    ...
    await axios
      .post(
        ...
        // `${URLS.AuthURL}/getVasooliCountWithOutDemand?districtCode=${location?.state?.districtCode}&talukaCode=${location?.state?.talukaCode}`,
        revenueYear == '2024-2025'
          ? `${URLS.AuthURL}/getVasooliCountWithOutDemand?districtCode=${location?.state?.districtCode}&talukaCode=${location?.state?.talukaCode}`
          : `${URLS.AuthURL}/getVasooliCountWithOutDemandPre?districtCode=${location?.state?.districtCode}&talukaCode=${location?.state?.talukaCode}`,
      )
      .then((res) => {
        //console.log(res, 'getVasooliCountWithOutDemand-------->');
        try {
          setTableData(
            res.data.map((row, i) => ({
              srNo: i + 1,
          ...
          console.log(err, 'Error in block getVasooliCountWithOutDemand');
        }
      });
  };
                ...
                <tr>
                  <th colSpan={24}>
                    <h3 style={{ color: 'red' }}>
                      ...
                      <b>१००% मागणी निश्चिती न करता वसूली सुरू केलेल्या गावांची संख्या</b>
                    </h3>
                  </th>
                </tr>
                    ...
                    <h4 style={{ color: 'red' }}>
                      <pre>
                        <b>
                          ...
                          {this.props.districtName} मधील १००% मागणी निश्चिती न करता वसूली सुरू
                          केलेल्या गावांची संख्या
