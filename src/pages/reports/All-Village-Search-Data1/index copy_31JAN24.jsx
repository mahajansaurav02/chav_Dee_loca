                  ...
                  this.props.dataToMap.map((r, i) => (
                    <tr key={i}>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.oneTimeDataEntry}</td>
                        </>
                      ) : (
                        <>
                          <td
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form17KaJaPa}</td>
                        </>
                      ) : (
                        <>
                          <td style={{ backgroundColor: r.form17KaJaPa > 0 ? 'skyblue' : 'white' }}>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.addLandRevenue}</td>
                        </>
                      ) : (
                        <>
                          <td
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.khataMerge}</td>
                        </>
                      ) : (
                        <>
                          <td style={{ backgroundColor: r.khataMerge > 0 ? 'skyblue' : 'white' }}>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form1}</td>
                        </>
                      ) : (
                        <>
                          <td style={{ backgroundColor: r.form1 > 0 ? 'skyblue' : 'white' }}>
