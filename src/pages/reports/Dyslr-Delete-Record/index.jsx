...
function Report() {
  ...
  const getTableData = async () => {
    ...
    sendRequest(
      `${URLS.BaseURL}/form1Dyslr/getFormDyslrDeleteEntries?cCode=${codeVillage}`,
      'GET',
      null,
      (r) => {
        ...
        setTableData(
          r.data.form1DyslrData.map((r) => ({
            ...
            cultivableAreaInt: r.cultivableAreaInt /*  getPotkharabaTypeAr(
    ...
    <div>
      <Card>
        <h1 style={{ textAlign: 'center' }}>
          गाव नमुना एक Dyslr(आकारबंद) वगळण्यात आलेले भूमापन क्रमांक
        </h1>
