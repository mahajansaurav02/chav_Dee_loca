    ...
    sendRequest(
      ...
      (res) => {
        ...
        res.data.map((r, i) => {
          ...
          setEkunWasuli((prevEkunWasuli) => prevEkunWasuli + parseFloat(r.vasuliCompleted));
          setMagnipaikiWasuli(
            (prevMagnipaikiWasuli) => prevMagnipaikiWasuli + parseFloat(r.vasuliWithoutdemand),
          );
        ...
        setTableData(
          res.data.map((r, i) => ({
            ...
            form17: r.form17,
            form19: r.form19,
            ekunWasuli: r.vasuliCompleted,
            magnipaikiWasuli: r.vasuliWithoutdemand,
          })),
          message.success('Records Fetched Successfully'),
        );
      },
            ...
            <table className={styles.report_table}>
              ...
              <tbody>
                  ...
                  this.props.dataToMap.map((r, i) => (
                    <tr key={i}>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form1a}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form1b}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form1c}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form1d}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form1e}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form2}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form6b}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form6d}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form7a}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form7b}</td>
                        </>
                      ) : (
                        <>
                      ...
                      this?.props?.dataToMap1?.find(
                        ...
                        <>
                          <td style={{ backgroundColor: 'skyblue' }}>{r.form17}</td>
                        </>
                      ) : (
                        <>
                      ...
                      <td style={{ backgroundColor: r.khatedarNumber > 0 ? 'skyblue' : 'white' }}>
                        {r.khatedarNumber}
                      </td>
                      <td style={{ backgroundColor: r.ekunWasuli > 0 ? 'skyblue' : 'white' }}>
                        {r.ekunWasuli}
                      </td>
                      <td style={{ backgroundColor: r.magnipaikiWasuli > 0 ? 'skyblue' : 'white' }}>
                        {r.magnipaikiWasuli}
                      </td>
                ...
                <tr>
                  ...
                  <td>
                    <b>{this.props.ekunWasuli}</b>
                  </td>
                  <td>
                    <b>{this.props.magnipaikiWasuli}</b>
                  </td>
