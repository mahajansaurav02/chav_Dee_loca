                  ...
                  <div>
                    <Chart
                      ...
                      series={[
                        ...
                        parseInt(totalKhatedar), // Green
                        parseInt(totalKhatedar - demandGenerated), // Green
                      ]}
                      options={{
                        labels: [
                          'मागणी निश्चित झालेली खातेदार संख्या % मध्ये',
                  ...
                  <div>
                    <Chart
                      ...
                      series={[
                        ...
                        parseInt(Wasulipatrakhatedar),
                        parseInt(Wasulipatrakhatedar - khatedarAmountReceived),
                      ]}
                      options={{
                        labels: [
                          'वसुली पूर्ण झालेली खातेदार संख्या % मध्ये',
                ...
                {totalNetAmount === 0 ? (
                  ...
                  <div style={{ marginTop: '20px' }}>
                    <Chart
                      ...
                      width={450}
                      height={250}
                      series={[parseInt(totalNetReceived), 
