...
function DemandNotification() {
  ...
  const onDemandSearch = async () => {
    if (textInput !== null && textInput !== undefined && textInput) {
      ...
      // if (dt.getMonth() >= 1 && dt.getMonth() <= 7) {
      //   if (dt.getMonth() == 1) {
      ...
      const article = {
        ...
        cCode: codeVillage,
        khataNo: khataNoWithHash,
        noticeFeesApplicable: 'Y',
          ...
          if (res.data.length > 0) {
            var receiptsTest = res.data.map(function (r) {
              ...
              var test = {
                ...
                akrushiKAR: r.jmAkrushik + r.zpAkrushik + r.gpAkrushik,
            ...
            message.info('Demand Not Generated For Given Khata No');
          } else if (res.status === 204) {
            message.info('Cannot Generate Demand Notice Of Entered Khata-No');
          } else {
          ...
          <Row>
            ...
            <Col xl={7} lg={7} md={7} sm={7} xs={24}>
              <Button
                ...
                onClick={() => {
                  if (textVillage && revenueYear && textInput) {
                    onDemandSearch();
