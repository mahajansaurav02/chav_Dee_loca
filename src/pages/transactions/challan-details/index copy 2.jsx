...
function ChallanDetails() {
  ...
  const saveChallan = async () => {
    ...
    //if (upperModalData.totalOfHead0029 != null && file0029Flag == false) {
    if (
      upperModalData.totalOfHead0029 != null &&
      file0029Flag == false &&
      (upperModalData.totalOfHead0045 == null || upperModalData.totalOfHead0045 == 0) &&
      file0045Flag == false
    ) {
      //alert('Please Image 1 0029');
      message.error(' please choose भरणा केलेले चलन अपलोड file (0029)');
    } else if (
      upperModalData.totalOfHead0045 != null &&
      file0045Flag == false &&
      (upperModalData.totalOfHead0029 == null || upperModalData.totalOfHead0029 == 0) &&
      file0029Flag == false
    ) {
      //alert('Please Image 2 0045');
      message.error(' please choose भरणा केलेले चलन अपलोड file (0045)');
    } else if (
      upperModalData.totalOfHead0029 != null &&
      upperModalData.totalOfHead0045 != null &&
      file0029Flag == false &&
      ...
      message.error(' please choose the upload file for (0029) and (0045)');
    } else if (
      upperModalData.totalOfHead0029 != null &&
      file0029Flag == true &&
      upperModalData.totalOfHead0045 != null &&
    ...
    // console.log(challan0029Flag, '----------------------------challan0029Flag');
    // console.log(file0029Flag, '----------------------------file0029Flag');

    // console.log(challan0045Flag, '----------------------------challan0045Flag');
    // console.log(file0045Flag, '----------------------------file0045Flag');
