...
function HomepageThalati(props) {
  ...
  // const getStarRatingCount = async () => {
                ...
                {totalLiveKhatedar === 0 ? (
                  <div>
                    <Chart
                      ...
                      series={[50, 50]}
                      // series={[
                      //   parseInt(totalLiveKhatedar - totalKhatedar),
                      //   parseInt(totalLiveKhatedar),
                      // ]}
                      options={{
                        labels: [
                        ...
                        //           // formatter: function () {
                        //           //   return 100001;
                        //           //   //return parseInt(AugPin1);
                        //           //   // return parseInt(totalLiveKhatedar);
                        //           // },
                        //         },
                        //       },
                        //     },
                  ...
                  <div>
                    <Chart
                      ...
                      series={[
                        ...
                        parseInt(demandGenerated),
                        parseInt(AugPin1 - demandGenerated),
                      ]}
                      options={{
                        labels: [
                          'मागणी निश्चित झालेली खातेदार संख्या % मध्ये',
                  ...
                  <div>
                    <Chart
                      ...
                      options={{
                        ...
                        //         total: {
                        //           label: 'Total : ' + totalSurveyNumber,
                        //           show: true,
                        //           color: 'red',
                        //           // showAlways: false,

                        //           // formatter: function () {
                        //           //   let a = parseInt(totalSurveyNumber);
                        //           //   console.log(b, '----a');
                        //           //   //return 100002333;
                        //           //   //return AugPin1;
                        //           //   return a;
                  ...
                  <div style={{ marginTop: '20px' }}>
                    <Chart
                      ...
                      series={[
                        ...
                        // parseInt(targetData - totalNetReceived)
                        parseInt(sankirnWith),
                        parseInt(targetData - sankirnWith),
                      ]}
                      options={{
                        labels: [
                          'वसुली पूर्ण झालेली रक्कम % मध्ये',
