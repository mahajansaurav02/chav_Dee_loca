...
function HomepageThalati(props) {
  ...
  const [sankirnMahsool, setSankirnMahsool] = useState(0);
  ...
  const [jamabandinew, setJamabandinew] = useState(0);
  ...
  const handleOnChangeForRevenueYear = (e) => {
    setRevenueYear(e);
  };
  ...
  const getStarRatingCount = () => {
    console.log('In getStarRatingForTalathi');
    let talukaCode = JSON.parse(localStorage.getItem('talukaCode'));
    let getcCode = JSON.parse(localStorage.getItem('villageData'));
    // &isCompleted=Y
    let cCode = getcCode[0]?.cCode;
    sendRequest(
      `${URLS.BaseURL}/restservice/getStarRatingForTalathi?cCode=${cCode}&talukaCode=${talukaCode}`,
      'GET',
      null,
      (res) => {
        // console.log('Star Rating Count....', res?.data);
        setStarRating1(res?.data);
      },
      (err) => {
        console.log(err);
      },
    ...
    sendRequest(
      `${URLS.BaseURL}/restservice/getStarRatingDemandGenerationCount?cCode=${cCode}&talukaCode=${talukaCode}&districtCode=${districtCode}`,
      'GET',
      null,
      (res) => {
        // console.info('Star Rating Count 222....', res?.data);
        setStarRating2(res?.data);
      },
      (err) => {
        console.log(err);
      },
  ...
  const TotalLiveDemandDetails = async () => {
    sendRequest(
      ...
      (res) => {
        ...
        setSankirnMahsool(parseInt(res.data.sankirnMahsool[0].sankirnMahsool));
  ...
  // const JmabandiPramane = async () => {
  //   sendRequest(
  //     `${URLS.BaseURL}/restservice/getJamabandi?cCode=${codeVillage}&revenueYear=${revenueYear1}`,
  //     'GET',
  //     null,
  //     (res) => {
  //       console.log(res.data, '-------data--------Jambandi_P');

  //      setJamabandinew(parseInt(res?.data?.landRevenueDemandData[0].jamabandi_p));
  //     },
  //   );
  // };
  ...
  // console.info('demandGenerated->', demandGenerated);
  // console.info('AugPin1 - demandGenerated->', AugPin1 - demandGenerated);
  // useEffect(() => {
  //   getStarRatingCount();
  // }, [revenueYear1]);
  return (
                  ...
                  <Row>
                    <Col xl={24} lg={24} md={18} sm={18} xs={18}>
                      ...
                      <center style={{ marginBottom: '30px' }}>
                        ...
                        <h1 style={{ fontSize: '2.5em' }}>{jamabandinew}</h1>
                      </center>
                    </Col>
                  </Row>
                </Paper>
                    ...
                    <div>
                      <Chart
                        ...
                        series={[
                          ...
                          parseInt(AugPin1 - demandGenerated), // Green
                        ]}
                        options={{
                          labels: [
                            'मागणी निश्चित झालेली खातेदार संख्या % मध्ये',
                    ...
                    <div>
                      <Chart
                        ...
                        series={[
                          ...
                          parseInt(AugPin1 - khatedarAmountReceived),
                        ]}
                        options={{
                          labels: [
                            'वसुली पूर्ण झालेली खातेदार संख्या % मध्ये',
                    ...
                    <Row>
                      <Col xl={24} lg={24} md={18} sm={18} xs={18}>
                        <h3 style={{ padding: '2px' }}>
                          <b>तलाठी कामकाजाचा निर्देशांक (स्टार रेटिंग)</b>
                        </h3>
                        {/* {console.info('ratinglist', ratinglist)} */}
                        <center>
                          {/* {ratinglist.length !== 0 &&
                                ...
                                >
                                  <span style={{ textAlign: 'left', width: '150px' }}>
                                    {item.name === 'list1'
                                      ? 'गांव नमुने अद्यावत'
                                      : item.name === 'list2'
                                      ? 'मागणी निश्चिती खातेदार संख्या'
                                      : 'फेरफार निकाली काढण्याचे सरासरी दिवस'}
                                  </span>
                                  {/* <h1 style={{ fontSize: '2.5em' }}> {demandGenerated}</h1> */}
                          {/* <Rating starRate={item} />{' '} */}
                          {/* </div> */}
                          {/* ); */}
                          {/* })} */}
                      ...
                      <Col xl={24} lg={24} md={18} sm={18} xs={18}>
                        ...
                        <center>
                          <h1 style={{ fontSize: '2.5em' }}>
                            {' '}
                            {totalNetReceived - sankirnMahsool}
                          </h1>
                        </center>
                      </Col>
                    </Row>
                  ...
                  >
                    ...
                    <Row>
                      <Col xl={24} lg={24} md={18} sm={18} xs={18}>
                        ...
                        <center>
                          <h1 style={{ fontSize: '2.5em' }}> {sankirnMahsool}</h1>
                        </center>
                      </Col>
                    </Row>
                  </Paper>
                    ...
                    <div style={{ marginTop: '20px' }}>
                      <Chart
                        ...
                        series={[
                          ...
                          parseInt(sankirnWithOut),
                          parseInt(totalNetAmount - sankirnWithOut),
                        ]}
                        options={{
                          labels: [
                            'वसुली पूर्ण झालेली रक्कम % मध्ये',
                  ...
                  {totalNetAmount === 0 ? (
                    ...
                    <div style={{ marginTop: '20px' }}>
                      <Chart
                        ...
                        width={450}
                        height={250}
                        series={[parseInt(sankirnMahsool), parseInt(targetData - sankirnMahsool)]}
                        options={{
                          labels: [
                            'वसुली पूर्ण झालेली खातेदार संख्या % मध्ये',
                            'वसुली पूर्ण न झालेली खातेदार संख्या % मध्ये',
...
export default HomepageThalati;
