...
function TableForm14() {
  ...
  //Nirank Code
  //isActive when in Nirank Form when isNirank and is Completed checkbox is selected
  const getNirankReq = () => {
    ...
    sendRequest(
      ...
      (res) => {
        // var a = res?.data;
        console.log(res);
        const singleVal11 = res?.data?.find((obj) => obj?.formId === '14');
        console.log('singleVal data...', singleVal11);
        setSingleVal(res?.data?.find((obj) => obj?.formId === '14'));
